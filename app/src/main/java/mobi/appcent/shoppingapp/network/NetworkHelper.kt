package mobi.appcent.shoppingapp.network

import mobi.appcent.shoppingapp.BuildConfig
import mobi.appcent.shoppingapp.network.service.ShoppingService
...
class NetworkHelper {
    var shoppingService : ShoppingService? = null
